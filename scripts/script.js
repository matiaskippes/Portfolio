...
covid.addEventListener('click', (e) => {
    location.href = "https://github.com/matiaskippes/covid-analytics"
})

cashier.addEventListener('click', (e) => {
    location.href = "https://github.com/matiaskippes/CajeroAutomatico"
})

searcher.addEventListener('click', (e) => {
    location.href = "https://github.com/matiaskippes/TRZearcher"
})

finance.addEventListener('click', (e) => {
    location.href = "https://github.com/matiaskippes/Finance-Firebase"
})

inventory.addEventListener('click', (e) => {
    location.href = "https://github.com/matiaskippes/REST-API-Market"
})
